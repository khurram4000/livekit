...
# ============================================================================
# Configure ElevenLabs TTS plugin for LiveKit Agents.
# We initialize at module level so startup can fail fast if credentials/config are invalid.

ELEVENLABS_VOICE_ID = os.getenv("ELEVENLABS_VOICE_ID", "EXAVITQu4vr4xnSDxMaL")
ELEVENLABS_MODEL = os.getenv("ELEVENLABS_MODEL", "eleven_flash_v2_5")
ELEVENLABS_SPEED = float(os.getenv("ELEVENLABS_SPEED", "0.9"))  # slower than default 1.0
ELEVENLABS_STABILITY = float(os.getenv("ELEVENLABS_STABILITY", "0.5"))
ELEVENLABS_SIMILARITY = float(os.getenv("ELEVENLABS_SIMILARITY_BOOST", "0.8"))
try:
